...
Non-zero abundance ranges from `r min(dat$y, na.rm = TRUE)` to `r max(dat$y, na.rm = TRUE)`; we will model as a negative binomial hurdle model. Occurrence will be fitted with a binomial model. 
